...
class Experimentor():
    ...
    def __init__(self, numColumns=None, cellsPerColumn=None, columnsPerChar=None, 
                 ...
                 graph=None, do_ERG=False, 
                 nof_strings=1000, 
                 nof_uniqueStrings='mix', nof_copies_uniqueStrings=10, 
                 sort_by_length=True, verbose=2):
        ...
        self.rg = Reber_Grammar(numColumns=self.N, columnsPerChar=self.k, graph=graph)
        ...
        self.rg_inputoutput, self.nof_strings = self.rg.generate_RGInputOutput(self.do_ERG, nof_strings,
                                                                               nof_uniqueStrings, nof_copies_uniqueStrings,
                                                                               self.sort_by_length)
    ...
    def run_experiment(self):
        ...
        for string_idx in range(self.nof_strings):
            ...
            for step in range(len(in_string)):
                ...
                if step == 0:
                    ...
                    # REPORT ERROR AND BREAK THE EXECUTION!
                    ...
                    if np.count_nonzero(winnerCells) > self.maxSynapsesPerDendrite:
        ...
        dict_results = {
            ...
            'rg_inputoutput': self.rg_inputoutput}
