...
class HTM_CELL:
    ...
    def update_cell_dendritePermanences(self, dendrite_idx=None, prev_state=None, decay=False):
        ...
        # =============================================================================
            ...
            self.dendrites[dendrite_idx] = self.dendrites[
                                               dendrite_idx] + self.perm_increment * prev_state_ - self.perm_decrement
    ...
    def undo_cell_dendriteReinforcement(self, dendrite_idx=None, reinforcedSynapses=None):
        ...
        list_nonzeroSynapses_idx = set(list_nonzeroSynapses_idx) - set(list_nonzeroSynapses_idx).intersection(
            list_reinforcedSynapses_idx)

        for i in list_nonzeroSynapses_idx:
            nonzeroSynapses[i] = 1

        self.dendrites[dendrite_idx] = self.dendrites[
                                           dendrite_idx] - self.perm_increment * reinforcedSynapses + self.perm_decrement * nonzeroSynapses
    ...
    def reset_cell_dendrite(self, dendrite_idx=None, resetSynapses=None):
        ...
        self.dendrites[dendrite_idx] = mask_otherSynapses + np.array(
