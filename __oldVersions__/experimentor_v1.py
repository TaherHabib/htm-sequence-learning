...
from htm_net_v1 import HTM_NET
...
class Experimentor():
    ...
    def __init__(self, numColumns=None, cellsPerColumn=None, columnsPerChar=None, 
        ...
        self.htm_network = HTM_NET(cellsPerColumn=self.M, numColumns=self.N,
                                   ...
                                   avgLen_reberString=self.avgLen_reberString, verbose=self.verbose)
    ...
    def run_experiment(self):
        ...
        df_res = pd.DataFrame(columns=('reber_string', 'htm_states', 'htm_preds'))#, 'htm_predDendrites', 'htm_network'))
        ...
        for string_idx in range(self.nof_strings):
            ...
            for step in range(len(in_string)):
                ...
                if self.verbose > 1:
                    print(color.BLUE, color.BOLD, 'Running step: ', step, ' for: ', in_string_alpha[step], color.END, color.END)
                
                # in_string[step] is a binary 1xN vector (np.array) with 'k' 1s.
                curr_state, curr_pred, curr_predDendrites  = self.htm_network.get_net_state(prev_pred=curr_pred,
                                                                                            curr_input=in_string[step])
                htm_states.append(curr_state)
                htm_preds.append(curr_pred)
                htm_predDendrites.append(curr_predDendrites)
                ...
                if step == 0:
                    ...
                    multiCellMaxOverlap = self.htm_network.update_net_synapticPermanences(curr_state=curr_state,
                    ...
                    if multiCellMaxOverlap == True:
                        print(color.RED, color.BOLD, '::::::::::::::::::::::::::::::::::::::::::: MultiCellMaxOverlap', \
                              ' :::::::::::::::::::::::::::::::::::::::::::', color.END, color.END)
                ...
                if step == len(in_string)-1:
                    ...
                    if self.verbose > 1:
                        print(color.BLUE, color.BOLD, 'Running step: ', step + 1, ' for: Z', color.END, color.END)
        ...
        dict_results = {
            'results': df_res,
            'network': self.htm_network.get_NETWORK(char_onehot='all')
            }
